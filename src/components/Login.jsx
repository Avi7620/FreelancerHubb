        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of professionals building their careers and finding
              amazing projects.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
            <p className="text-blue-100 mb-4 italic">
              "Freelancer Hub transformed my career. I've connected with amazing
              clients and built lasting professional relationships."
            </p>
